...
1. `set()` - 154 edges
2. `ConfigNamespace` - 142 edges
3. `TemplateNamespace` - 116 edges
4. `dn()` - 112 edges
...
- `Vi()` --calls--> `Nt()`  [INFERRED]
  D:\ToolsMatic\assets\vendor\pro-image-editor\tui-image-editor.min.js → D:\ToolsMatic\extensions\toolsmatic-pdf-toolkit\vendor\pdf-lib.min.js
...
Cohesion: 0.08
Nodes (8): CFFCompiler, CFFDict, CFFOffsetTracker, CFFPrivateDict, CFFStrings, createDict(), emptyPrivateDictionary(), parsePrivateDict()
